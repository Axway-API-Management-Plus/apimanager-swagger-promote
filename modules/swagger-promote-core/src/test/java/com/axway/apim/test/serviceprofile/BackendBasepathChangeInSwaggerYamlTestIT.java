...
@Test
public class BackendBasepathChangeInSwaggerYamlTestIT extends TestNGCitrusTestRunner {
	...
	public void run(@Optional @CitrusResource TestContext context) throws IOException, AppException {
		...
		variable("apiPath", "/basepath-yaml-changed-in-swagger-test-${apiNumber}");
		variable("apiName", "Basepath changed in Swagger Yaml Test ${apiNumber}");

		echo("####### Importing API: '${apiName}' on path: '${apiPath}' with following settings: #######");
		createVariable(ImportTestAction.API_DEFINITION,  "/com/axway/apim/test/files/basic/petstore-with-invalid-host.yaml");
		...
		createVariable(ImportTestAction.API_DEFINITION,  "/com/axway/apim/test/files/basic/petstore-without-any-host.yaml");
		createVariable(ImportTestAction.API_CONFIG,  "/com/axway/apim/test/files/serviceprofile/2_backend_basepath_test.json");
		createVariable("backendBasepath", "https://petstore.swagger.io");
